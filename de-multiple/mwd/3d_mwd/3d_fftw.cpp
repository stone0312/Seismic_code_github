             ...
             for(iy=0;iy<nr;iy++)
               {
                  if((in1==NULL)||(out1==NULL))
                  ...
                  else
                   {
                     ...
                     for(ix=0;ix<ns;ix++)
                       {   
                         u3fft[ix][iy][it].real()=out3[ix][0]/ns;
                         u3fft[ix][iy][it].imag()=out3[ix][1]/ns;
                       }   
                   }
            ...
            for(iy=0;iy<nr;iy++)
             {
              for(it=0;it<ltt;it++)
               {
                 swq2.write((char*)&u3fft[ix][iy][it].real(),sizeof(u3fft[ix][iy][it].real()));        
                 swq3.write((char*)&u3fft[ix][iy][it].imag(),sizeof(u3fft[ix][iy][it].imag()));        
               }
            }
          }
        ...
        for(ix=0;ix<ns;ix++)
          {
             for(iy=0;iy<nr;iy++)
              {
                for(it=0;it<lt;it++)
                  swq4.write((char*)&u3fft[ix][iy][it].real(),sizeof(u3fft[ix][iy][it].real()));
              }
          }
*/
       for(iy=0;iy<nr;iy++)
              {
                for(it=0;it<lt;it++)
                  swq4.write((char*)&u3fft[d][iy][it].real(),sizeof(u3fft[d][iy][it].real()));
              }
