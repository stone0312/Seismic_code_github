...
//  return 0;
  ...
  complex <float> ***u3fft1;
  u3fft1=alloc3complex(ltt,nrb,nsb);
  
//  complex <float> ***mkf;
//  mkf=alloc3complex(ltt,nrb,nsb);
  complex <float> ***mkyf;
  mkyf=alloc3complex(ltt,nrb,nsb);
  complex <float> ***mkxf;
  mkxf=alloc3complex(ltt,nrb,nsb);
  complex <float> ***mf;
  mf=alloc3complex(ltt,nrb,nsb);
  float ***m;
  m=alloc3float(ltt,nrb,nsb);
...
//              u3fft1[ix][iy][it].real()=0.0;
//              u3fft1[ix][iy][it].imag()=0.0;
//             mkf[ix][iy][it].real()=0.0;
//             mkf[ix][iy][it].imag()=0.0;
//              mkyf[ix][iy][it].real()=0.0;
//              mkyf[ix][iy][it].imag()=0.0;
//              mkxf[ix][iy][it].real()=0.0;
//              mkxf[ix][iy][it].imag()=0.0;
//              mf[ix][iy][it].real()=0.0;
//              mf[ix][iy][it].imag()=0.0;
//              m[ix][iy][it]=0.0;
            }
          }
        } 
             ...
             for(iy=0;iy<nrb;iy++)
               {
                  if((in1==NULL)||(out1==NULL))
                  ...
                  else
                   {
                     ...
                     for(ix=0;ix<nsb;ix++)
                       {   
                         u3fft1[ix][iy][it].real()=out3[ix][0]/nsb;
                         u3fft1[ix][iy][it].imag()=out3[ix][1]/nsb;
                       }   
                   }
            ...
            for(iy=0;iy<nrb;iy++)
              {
                       ...
                       else
                          {
                             if(pow(omega[it]/v,2)-pow(kx[ix],2)-pow(ky[iy],2)<0.0) 
                             ...
                             else if(pow(omega[it]/v,2)-pow(kx[ix],2)-pow(ky[iy],2)>pow(cos(2*pai*theta/360.0)*omega[it]/v,2))
                               {
                                  ...
                                  ps.imag()=-2*dep*kz;
                                  u3fft1[ix][iy][it]=u3fft1[ix][iy][it]*exp(ps);
                               }
                            else
                               {
                                  u3fft1[ix][iy][it].real()=0.0;
                 ...
                 for(it=ltt/2+1;it<ltt;it++)
                    {
                      u3fft1[ix][iy][it].real()=u3fft1[ix][iy][ltt-it].real();
                      u3fft1[ix][iy][it].imag()=-u3fft1[ix][iy][ltt-it].imag();
                    }
             ...
             for(iy=0;iy<nrb;iy++)
               {
                  if((in2==NULL)||(out2==NULL))
                  ...
                  else
                   {
                     for(ix=0;ix<nsb;ix++)
                        {
                           in6[ix][0]=u3fft1[ix][iy][it].real();
                           in6[ix][1]=u3fft1[ix][iy][it].imag();
                        }
                     fftwf_execute(p6);

                     for(ix=0;ix<nsb;ix++)
                       {
                         mkyf[ix][iy][it].real()=out6[ix][0];
                         mkyf[ix][iy][it].imag()=out6[ix][1];
                       }
                   }
             ...
             for(ix=0;ix<nsb;ix++)
               {
                  if((in2==NULL)||(out2==NULL))
                  ...
                  else
                   {
                     for(iy=0;iy<nrb;iy++)
                        {
                           in5[iy][0]=mkyf[ix][iy][it].real();
                           in5[iy][1]=mkyf[ix][iy][it].imag();
                        }
                     ...
                     for(iy=0;iy<nrb;iy++)
                       {
                         mf[ix][iy][it].real()=out5[iy][0];
                         mf[ix][iy][it].imag()=out5[iy][1];
                       }
                   }
               }
             ...
             for(iy=0;iy<nrb;iy++)
               {
                  if((in2==NULL)||(out2==NULL))
                  ...
                  else
                   {
                     for(it=0;it<ltt;it++)
                        {
                           in4[it][0]=mf[ix][iy][it].real();
                           in4[it][1]=mf[ix][iy][it].imag();
                        }

                     fftwf_execute(p4);
 
                     for(it=0;it<lt;it++)
                       m[ix][iy][it]=out4[it][0];
        ...
        for(ix=0;ix<ns;ix++)
          {
             for(iy=0;iy<nr;iy++)
              {
                for(it=0;it<lt;it++)
                  swq2.write((char*)&m[ix+bou_x][iy+bou_y][it],sizeof(m[ix+bou_x][iy+bou_y][it]));
              }
          }
*/ 
             for(iy=0;iy<nr;iy++)
              {
                for(it=0;it<lt;it++)
                  swq2.write((char*)&m[d+bou_x][iy+bou_y][it],sizeof(m[d+bou_x][iy+bou_y][it]));
              }
