            ...
            for(iy=0;iy<nrb;iy++)
              {
                       ...
                       else
                          {
                             if(pow(omega[it]/v,2)-pow(kx[ix],2)-pow(ky[iy],2)<0.0) 
                             ...
                             else if(pow(omega[it]/v,2)-pow(kx[ix],2)-pow(ky[iy],2)>pow(cos(2*pai*theta/360.0)*omega[it]/v,2))
                               {
                                  ...
                                  ps.imag()=-2*dep*kz;
                                  mf[ix][iy][it]=u3fft[ix][iy][it]*exp(ps);
                               }
                            else
                               {
                                  mf[ix][iy][it].real()=0.0;
                 ...
                 for(it=ltt/2+1;it<ltt;it++)
                    {
                      mf[ix][iy][it].real()=mf[ix][iy][ltt-it].real();
                      mf[ix][iy][it].imag()=-mf[ix][iy][ltt-it].imag();
                    }
             ...
             for(iy=0;iy<nrb;iy++)
               {
                  if((in2==NULL)||(out2==NULL))
                  ...
                  else
                   {
                     for(ix=0;ix<nsb;ix++)
                        {
                           in6[ix][0]=mf[ix][iy][it].real();
                           in6[ix][1]=mf[ix][iy][it].imag();
                        }
                     fftwf_execute(p6);

                     for(ix=0;ix<nsb;ix++)
                       {
                         mf[ix][iy][it].real()=out6[ix][0];
                         mf[ix][iy][it].imag()=out6[ix][1];
                       }
                   }
             ...
             for(ix=0;ix<nsb;ix++)
               {
                  if((in2==NULL)||(out2==NULL))
                  ...
                  else
                   {
                     for(iy=0;iy<nrb;iy++)
                        {
                           in5[iy][0]=mf[ix][iy][it].real();
                           in5[iy][1]=mf[ix][iy][it].imag();
                        }
        ...
        for(ix=0;ix<nsb;ix++)
           {
             ...
             for(iy=0;iy<nr;iy++)
              {
                for(it=0;it<lt;it++)
                  swq2.write((char*)&mf[d+bou_x][iy+bou_y][it].real(),sizeof(mf[d+bou_x][iy+bou_y][it].real()));
              }
