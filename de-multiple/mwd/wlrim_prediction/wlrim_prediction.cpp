...
int main()
{
   ...
   cout<<"Fna of Green's Function in x-t domain is===="<<fn1<<endl; 
   cout<<"Fna of Green's Function in x-f domain Real Parts is===="<<fn2<<endl; 
   cout<<"Fna of Green's Function in x-f domain Imaginary Parts is===="<<fn3<<endl; 
  ...
  for(is=0;is<ns;is++)
    {
       ...
       for(ir=0;ir<nr;ir++)
          for(it=0;it<lt;it++)
           swq1.read((char*)&g[ir][it],sizeof(g[ir][it]));
       ...
       for(ir=0;ir<nr;ir++)
          {
            ...
            for(it=0;it<ltt;it++)
             {
               gf[ir][it].real()=out5[it][0]/ltt;
               gf[ir][it].imag()=out5[it][1]/ltt;
             }
          }
       ...
       for(ir=0;ir<nr;ir++)
        for(it=0;it<ltt;it++)
          { 
           swq2.write((char*)&gf[ir][it].real(),sizeof(gf[ir][it].real()));
           swq3.write((char*)&gf[ir][it].imag(),sizeof(gf[ir][it].imag()));
          }
    }
