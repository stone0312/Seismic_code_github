...
int main()
{
  ...
  ifstream swq;
  swq.open("weight_estimation_MCG.par");
  swq>>fn1>>fn2>>fn3>>fn4>>fn9>>fn10>>fn5>>fn6>>fn7>>fn8>>ns>>nr>>lt>>dt>>fmin>>fmax>>lamda>>coe1>>l;
  swq.close();
  ...
  int ltt,ifmin,ifmax,is,ir,ir1,ir2,it,it1,irtmp,irtmp1; 
  ltt=2*lt;
  ...
  mf1dnewnew=alloc1complex(nr);
  complex<float> **mf2dnew;
  mf2dnew=alloc2complex(nr,ltt);
  float **mt2dnew;
...
/*
      cout<<"Ishot is==== "<<is<<endl;
      for(ir=0;ir<nr;ir++)
        {
           cout<<"Target Trace is==== "<<ir<<endl;
           cout<<"Secondary Source Number Beagin and End at "<<irbeg[ir]<<" , "<<irend[ir]<<endl;
        }
     return 0;
*/
