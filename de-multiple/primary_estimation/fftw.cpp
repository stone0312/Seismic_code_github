...
//  ltt=lt;
  ...
  ifstream swq2;
  swq2.open("/data4/swq/primary_estimation/50th_shot_weights_MCG5_f5to100hz_E2_pri_filter_tp_mpi.dat",ios::binary);
  if(!swq2)
    {
  ...
  ofstream swq4;
  swq4.open("/data4/swq/primary_estimation/50th_shot_weights_MCG5_f5to100hz_E2_pri_filter_tp_mpi_real.dat",ios::binary);
 
  ofstream swq44;
  swq44.open("/data4/swq/primary_estimation/50th_shot_weights_MCG5_f5to100hz_E2_pri_filter_tp_mpi_imag.dat",ios::binary);

  ofstream swq444;
  swq444.open("/data4/swq/primary_estimation/50th_shot_weights_MCG5_f5to100hz_E2_pri_filter_tp_mpi_amp.dat",ios::binary);
...
//             mf1[it].real()=out2[it][0];
//             mf1[it].imag()=out2[it][1];
          }
