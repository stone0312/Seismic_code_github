...
//  ltt=lt;
  ...
  ifstream swq2;
  swq2.open("/data1/swq/srme_primary_est/csg_100shot_pre.dat",ios::binary);
  if(!swq2)
    {
  ...
  ofstream swq4;
  swq4.open("/data1/swq/srme_primary_est/csg_100shot_pre_real.dat",ios::binary);
 
  ofstream swq44;
  swq44.open("/data1/swq/srme_primary_est/csg_100shot_pre_imag.dat",ios::binary);
