...
int main()
{
  ...
  int ns,nr,lt,iter,iter_max,mcg_thre,irmin,irmax;
  ...
  ifstream swq;
  swq.open("primary_estimation_constraint.par");
  swq>>fn1>>fn2>>fn3>>fn4>>fn11>>fn22>>fn6>>fn7>>fn8>>ns>>nr>>lt>>dt>>fmin>>fmax>>min>>max>>lamda1>>iter_max>>n1>>n2>>mcg_thre;
  swq.close();
