...
//  ltt=2*lt;
  ...
  ifstream swq2;
  swq2.open("/data1/swq/beam_forming/har1_cut_order2_co_lt4001_dt2ms_sem_thre005_np61_nx21.dat",ios::binary);
  if(!swq2)
    {
  ...
  ofstream swq4;
  swq4.open("/data1/swq/beam_forming/2d_raw_ol_sem_thre01_np61_real.dat",ios::binary);
 
  ofstream swq44;
  swq44.open("/data1/swq/beam_forming/2d_raw_ol_sem_thre01_np61_imag.dat",ios::binary);

  ofstream swq444;
  swq444.open("/data1/swq/beam_forming/har1_cut_order2_co_lt4001_dt2ms_sem_thre005_np61_nx21_amp.dat",ios::binary);
