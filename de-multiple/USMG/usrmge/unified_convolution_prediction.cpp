...
int main()
{
   ...
   float ds,dr,sdep,rdep,dt,fmax,fmin,st_beg,st_end;
   int ltt;
   int ifmax,ifmin;
   ...
   swq>>fn1>>fn11>>fn2>>fn22>>fn3>>fn33>>fn4>>fn44>>fn5>>fn8>>nshot>>nr>>ds>>dr>>sdep>>rdep>>lt>>dt>>fmax>>fmin>>shot>>trace>>st_beg>>st_end>>v>>theta_max>>theta_min>>bou;
   swq.close();
   ...
   cout<<"Source Depth is===="<<sdep<<"m"<<endl; 
   cout<<"Receiver Depth is===="<<rdep<<"m"<<endl; 
