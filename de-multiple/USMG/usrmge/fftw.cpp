...
//  ltt=lt;
  ...
  ifstream swq2;
  swq2.open("/data200/swq/2d_modeling_data/csg_500shots.dat",ios::binary);
  if(!swq2)
    {
  ...
  ofstream swq4;
  swq4.open("/data4/swq/2d_modeling_data/csg_500shots_real.dat",ios::binary);
 
  ofstream swq44;
  swq44.open("/data4/swq/2d_modeling_data/csg_500shots_imag.dat",ios::binary);
