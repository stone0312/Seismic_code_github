...
//        abort();
   ...
   int *receiver=new int [nt];
   int *shot=new int [nshot];
                    ...
                    for(ir1=0;ir1<nt;ir1++)
                      {
                         for(ir2=0;ir2<nshot;ir2++)
                           {
                              if(receiver[ir1]==shot[ir2])
                                mf[i]+=usf[ir1][i]*urf[ir2][i];
                              else
                                {
                                   mf[i].real()+=0.0;
                                   mf[i].imag()+=0.0;
                      ...
                      mf[i].imag()/=(nt+nshot);
/*
                    for(ir1=0+int(0.0*nt);ir1<nt-int(0.0*nt);ir1++)
