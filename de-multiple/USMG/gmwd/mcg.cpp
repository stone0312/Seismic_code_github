...
/*
                              if(ir-ns1<10)    
                               {                          
                                 for(ix=ns1;ix<ir+1;ix++)
                                   {
                                     mcg1=su1[ix]*rd1[ix]+sd1[ix]*ru1[ix];       
                                     srmf[ir]+=mcg1;
                                     
                                    srmf[ir].real()/=(ir+1-ns1); 
                                    srmf[ir].imag()/=(ir+1-ns1); 
...
//                              else
//                               {
                                 for(ix=ns1;ix<ns1+int((ir-ns1)*st_beg);ix++)
                                   {
                                     mcg1=(0.0,0.0);
                                     srmf[ir]+=mcg1;
                                     swq8.write((char*)&(mcg1.real()),sizeof(mcg1.real()));
                                 ...
                                 for(ix=ns1+int((ir-ns1)*st_beg);ix<ns1+int((ir-ns1)*st_end)+1;ix++)
                                   {
                                     mcg1=su1[ix]*rd1[ix]+sd1[ix]*ru1[ix];
                                     srmf[ir]+=mcg1;
                                 ...
                                 for(ix=ns1+int((ir-ns1)*st_end)+1;ix<ir+1;ix++)
                                   {
                                     mcg1=(0.0,0.0);
                                     srmf[ir]+=mcg1;
                                     swq8.write((char*)&(mcg1.real()),sizeof(mcg1.real()));
...
/*
                              if(ns1-ir<10)
                               {
                                 for(ix=ir;ix<ns1+1;ix++)
                                   {
                                     mcg1=su1[ix]*rd1[ix]+sd1[ix]*ru1[ix];
                                     srmf[ir]+=mcg1;

                                     srmf[ir].real()/=(ns1+1-ir);
                                     srmf[ir].imag()/=(ns1+1-ir);
...
//                              else
//                              { 
                                 for(ix=ir;ix<ir+int((ns1-ir)*st_beg);ix++) 
                                   {
                                     mcg1=(0.0,0.0);
                                     srmf[ir]+=mcg1;                             
                                     swq8.write((char*)&(mcg1.real()),sizeof(mcg1.real()));
                                 ...
                                 for(ix=ir+int((ns1-ir)*st_beg);ix<ir+int((ns1-ir)*st_end)+1;ix++)
                                   {
                                     mcg1=su1[ix]*rd1[ix]+sd1[ix]*ru1[ix];
                                     srmf[ir]+=mcg1;
                                 ...
                                 for(ix=ir+int((ns1-ir)*st_end)+1;ix<ns1+1;ix++)
                                   {
                                     mcg1=(0.0,0.0);
                                     srmf[ir]+=mcg1;
                                     swq8.write((char*)&(mcg1.real()),sizeof(mcg1.real()));
...
//                               }   
                            ...
                            {
                               mcg1+=su1[ns1]*rd1[ns1]+sd1[ns1]*ru1[ns1];
                               srmf[ir]+=mcg1;
                               swq8.write((char*)&(mcg1.real()),sizeof(mcg1.real()));
                               swq9.write((char*)&(mcg1.imag()),sizeof(mcg1.imag()));
                            }
