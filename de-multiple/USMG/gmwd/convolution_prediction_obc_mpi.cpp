              ...
              for(ix=is;ix<ir;ix++)
                {
                    for(it=ifmin;it<ifmax;it++)
                     {
                       mcg[ix][it]=su[ix][it]*rd[ix][it]+sd[ix][it]*ru[ix][it]+su[ix][it]*ru[ix][it];
//                       mcg[ix][it]=su[ix][it]*rd[ix][it]+sd[ix][it]*ru[ix][it];
//                       mcg[ix][it]=su[ix][it]*ru[ix][it];
...
//                       mcg[ix][it]=su[ix][it]*rd[ix][it]+sd[ix][it]*ru[ix][it];
//                       mcg[ix][it]=su[ix][it]*ru[ix][it];
                       mcg[ix][it].real()/=(is-ir+1);
                       mcg[ix][it].imag()/=(is-ir+1);
                     }
                }
             }
