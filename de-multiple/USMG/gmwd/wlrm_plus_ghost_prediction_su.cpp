                 ...
                 else
                   {
                      if(pow(omega[it]/v,2)-pow(kx[ir],2)<0.0)
                      ...
                      else if(pow(omega[it]/v,2)-pow(kx[ir],2)>pow(cos(2*pai*theta/360.0)*omega[it]/v,2))
                        {
                             ...
                             ps4.real()=1-ps3.real()+lamda;
                             ps4.imag()=-1.0*ps3.imag();
                             ps4=exp(ps4);

                             ukfu[ir][it]=ukf[ir][it]/ps3;
                             ukfd[ir][it]=ukfu[ir][it]/ps4;
                             ...
                             ps6.real()=0.0;
                             ps6.imag()=-2*(wd-rdep)*kz;
                             ps6=exp(ps6);

                             ps7.real()=0.0;
                             ps7.imag()=-2*(wd+rdep)*kz;
                             ps7=exp(ps7);
...
int main()
{
   ...
   ifstream swq;
   swq.open("wlrm_plus_ghost_prediction_su.par");
...
//read data
       for(ir=0;ir<nr;ir++)
        {
          for(it=0;it<60;it++)
            swq1.read((char*)&suhead[ir][it],sizeof(suhead[ir][it]));
       ...
       for(ir=n;ir<nr;ir++)
        {
          for(it=0;it<60;it++)
            swq2.write((char*)&suhead[ir][it],sizeof(suhead[ir][it]));       
