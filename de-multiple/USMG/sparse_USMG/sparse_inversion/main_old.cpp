...
//	read_2d_float_rb(vobs,  nx, nz, vobsfile);
	...
	// sparse inversion.
	//l1norm_inversion_denoise( vobs[0], vinv[0], lambda, niu, nx*nz, nitermax, epsmin );
...
//v2.
	l1norm_denoise_tv_reg( vobs, vinv, lambda, niu, type, nx, nz, nitermax, epsmin, obj);
	//l1norm_denoise_tv_reg( vobs, vinv, lambda, niu, "l1", nx, nz, nitermax, epsmin, obj);
	//l1norm_denoise_tv_reg( vobs, vinv, lambda, niu, "iso", nx, nz, nitermax, epsmin, obj);
