...
//  ltt=lt;
  ...
  ifstream swq2;
  swq2.open("/data1/swq/sparse_USMG/4layer_usmg_test_new/wb75m/csg_100_shots_pre_sr5m_wb75m_ftp_up_l01.dat",ios::binary);
  if(!swq2)
    {
  ...
  ofstream swq4;
  swq4.open("/data1/swq/sparse_USMG/4layer_usmg_test_new/wb75m/csg_100_shots_pre_sr5m_wb75m_ftp_up_l01_real.dat",ios::binary);
 
  ofstream swq44;
  swq44.open("/data1/swq/sparse_USMG/4layer_usmg_test_new/wb75m/csg_100_shots_pre_sr5m_wb75m_ftp_up_l01_imag.dat",ios::binary);
