...
{
	return (complex <float>*)alloc1(n1,sizeof(complex <float>));
}

/* re-allocate a 1-d array of complexs */
complex <float>*realloc1complex(complex <float>*v, size_t n1)
{
	return ( complex<float>*)realloc1(v,n1,sizeof(complex <float>));
}
...
complex <float> **alloc2complex(size_t n1, size_t n2)
{
	return ( complex <float> **)alloc2(n1,n2,sizeof(complex <float>));
}

/* free a 2-d array of complexs */
void free2complex(complex <float>**p)
{
	free2((void**)p);
}

/* allocate a 3-d array of complexs */
complex <float> ***alloc3complex(size_t n1, size_t n2, size_t n3) 
{
        return (complex <float> ***)alloc3(n1,n2,n3,sizeof(complex <float>));
}

/*
float complex ***alloc3complex(size_t n1, size_t n2, size_t n3)
{
	return (float complex***)alloc3(n1,n2,n3,sizeof(float complex));
}
*/
/* free a 3-d array of complexs */
/*void free3complex(float complex ***p)
{
	free3((void***)p);
}
*/
